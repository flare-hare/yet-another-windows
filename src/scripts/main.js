/* =============================================================================
   ...
   import { setupCookie } from './cookie.js';
       ...
       setupCheckout(
         {
           ...
           orderNumberEl: document.querySelector('[data-order-number]'),
   ...
   document.addEventListener('DOMContentLoaded', () => {
     setupHowto();
     setupCookie({
       banner: document.querySelector('[data-cookie]'),
       acceptBtn: document.querySelector('[data-cookie-accept]'),
     });
     initConstructor();
   });
